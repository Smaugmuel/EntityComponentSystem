...
static constexpr auto DISJUNCT_D = std::disjunction<std::integral_constant<int, 543>, std::is_same<int, float>>::value;
static constexpr auto DISJUNCT_E = std::disjunction<std::integral_constant<int, 0>, std::is_same<int, float>>::value;
static constexpr auto DISJUNCT_F = std::disjunction<std::integral_constant<int, 0>, std::is_same<int, int>>::value;
#pragma endregion
